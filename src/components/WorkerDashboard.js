  ...
  const fetchData = async () => {
    if (currentUser) {
      ...
      if (userProfile && userProfile.profileCompleted) {
        ...
        // If on saved tab, fetch full details for saved jobs
        if (activeTab === "saved") {
          ...
          <div className="space-y-4">
             ...
             {filteredApplications.length === 0 ? (
                ...
                filteredApplications.map((app) => (
                    <div key={app.id} className="bg-white rounded-lg shadow border border-gray-200 p-6 flex flex-col md:flex-row justify-between items-center gap-6">
                        <div className="flex-1 w-full">
                            <div className="flex justify-between items-start">
                                ...
                                <span className="text-xs text-gray-400 bg-gray-50 px-2 py-1 rounded border border-gray-100 whitespace-nowrap ml-2">
                            ...
                            <p className="text-sm text-gray-500 mt-2">📍 {app.location} • ₹{app.salary}/mo</p>
                        </div>
                        
                        <div className="flex flex-col items-center min-w-[150px] gap-3 border-l pl-0 md:pl-6 border-gray-100 w-full md:w-auto">
                                ...
                                <div className="text-center w-full">
                                    <div className="flex gap-2 mb-2 w-full justify-center">
                                      <button 
                                        ...
                                        className="bg-green-500 text-white p-2 rounded-lg hover:bg-green-600 flex-1 flex justify-center"
                                        title="Chat"
                                      >
                                      ...
                                      <a 
                                        ...
                                        className="bg-blue-500 text-white p-2 rounded-lg hover:bg-blue-600 flex-1 flex justify-center"
                                        title="Call"
                                      >
                                        📞
                                      </a>
                                    </div>
                                    <div className="text-xs text-gray-500 mb-2 font-mono">{app.ownerPhone}</div>
